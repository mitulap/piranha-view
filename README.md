...
* It is assumed that maximum length of a Boat journey ( timeSlot ) is 6 hours. Although this code accepts more lengths, it might be possible that this application behaves weiredly for longer length of journey.
